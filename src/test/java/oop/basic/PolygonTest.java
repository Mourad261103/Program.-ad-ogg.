...
class PolygonTest {
    ...
    @BeforeEach
    void setUp() {
         square = new oop.basic.Polygon(new Point[]{new Point(0,0), new Point(0, 10), new Point(10,10), new Point(10, 0)});
        triangle = new oop.basic.Polygon(new Point[]{new Point(0,0), new Point(10, 0), new Point(5,10)});
    }
